...
export default function ViewTreatmentPlanProvidersGoalsSection() {
  const f = useViewTreatmentPlanFormContext();
  return (
    <>
      <div
        className={`mt-2 ${!f.residentGoal && !f.allergies && !f.Triggers && f.strengths?.length < 1 && f.Barriers?.length < 1 && "hide-data-on-view-print"}`}
      >
        ...
        <Row>
          ...
          <Col
            ...
            md={12}
            lg={12}
            className={`mb-3 ${f.Barriers?.length < 1 && "hidePrint" && "hide-data-on-view-print"}`}
          >
            <div className="view-details-grid view-details-grid-inline my-1 my-md-2 p-3">
              <Form.Group>
                ...
                <div className="radio-inline mt-1">
                  {[
                    ...
                    <Form.Check
                      ...
                      type="checkbox"
                      id={`barrier-${idx}`}
                      checked={f.Barriers?.includes(opt.value)}
                    />
                  ))}
                  {f.barriersBoolean && (
                    <input
              ...
              <Form.Group
                className={`mt-3 ${!f.barriersText && "hidePrint" && "hide-data-on-view-print"}`}
              >
