...
const ViewResidentIntakesContentPart1 = (props) => {
  const {
  ...
  return (
    <>
      {(page === 1 || printAllMode) && (
        <>
          <div ref={componentRef1} className="residentintakes-print">
            <h1 className="pdfTitle w-100 my-3 text-center resident-title hidden">
      ...
      {(page === 2 || printAllMode) && (
        <>
          <div ref={componentRef2} className="residentintakes-print">
            <h1 className="pdfTitle w-100 text-center my-3 resident-title hidden">
            ...
            <Row>
              <Col xs={12} md={12}>
                {(internalDisclosureList?.length ?? 0) > 0 && (
                ...
                <div className="d-flex">
                  {location === "/residentintakes-resident" && (
                    <Button
                      className="theme-button hide-print-btn me-2"
                      type="button"
                      onClick={() => setSigInModel2(!signInModel2)}
                    >
                      SAVED AND SIGNED
                    </Button>
                  )}
      ...
      {(page === 3 || printAllMode) && (
        <div ref={componentRefNew3} className="residentintakes-print">
          <h1 className="pdfTitle w-100 my-3 text-center resident-title hidden">
              ...
              <Col xs={12} md={12}>
                <div className="Residentrights">
                  ...
                  <p>
                    ...
                    in subsection (B) and the resident rights in subsection (E);
                    and
                  </p>
                  <p>3. Policies and procedures include:</p>
                  <p>
                    a. How and when a resident or the resident’s representative
                    is informed of the resident rights in subsection (E), and
                  </p>
                  <p>
                  ...
                  <p>i. Restraint;</p>
                  <p>
                    j. Retaliation for submitting a complaint to the Department
                    or another entity;
                  </p>
                  <p>
                  ...
                  <p>
                    ...
                    transfer, for reasons unrelated to the resident’s treatment
                  ...
                  <p>
                    ...
                    life or physical health; or is provided according to A.R.S.
                    § 36-512;
                  </p>
                  <p>
                  ...
                  <p>
                    ...
                    licensed capacity of less than 10 residents, if a behavioral
                    health professional determines that a resident’s treatment
                    requires the behavioral health residential facility to
                    restrict the resident’s ability to participate in the
                    activities in subsection (B)(3), the behavioral health
                    professional shall:
                  </p>
                  <p>
                  ...
                  <p>
                    ...
                    has found that the resident is not able to exercise a
                    specific right or category of rights;
                  </p>
                  <p>
                  ...
                  <p>
                    9. To receive a referral to another health care institution
                    if the behavioral health residential facility is not
                    authorized or not able to provide physical health services
                    or behavioral health services needed by the resident;
                  </p>
                  <p>
              ...
              <div className="d-flex">
                {location === "/residentintakes-resident" && (
                  <Button
                    className="theme-button hide-print-btn me-2"
                    type="button"
                    onClick={() => setSigInModel6(!signInModel6)}
                  >
                    SAVED AND SIGNED
                  </Button>
                )}
                ...
                <div className="d-flex">
                  {location === "/residentintakes-resident" && (
                    <Button
                      className="theme-button hide-print-btn me-2"
                      type="button"
                      onClick={() => setSigInModel3(!signInModel3)}
                    >
                      SAVED AND SIGNED
                    </Button>
                  )}
            ...
            <Card body className="mb-2">
              <Row>
                <Col xs={12} md={12}>
                  ...
                  <Form.Label className="mb-[0px] w-100">
                    ...
                    <br />
                    {/* TEMP-DISABLED-BHP-BHT-ADMIN (2026-04-26): Member initials replaced with checkbox toggle. */}
                    {/* Member initials {advanceDirectivesProvidedInfoInitials} */}
                    Date{" "}
                    {formatDateToMMDDYYYY(advanceDirectivesProvidedInfoDate)}
                  </Form.Label>
                  <Form.Label className="w-100">
                    ...
                    <br />
                    {/* TEMP-DISABLED-BHP-BHT-ADMIN (2026-04-26): Member initials replaced with checkbox toggle. */}
                    {/* Member initials {advanceDirectivesProvidedInfoRefusingInitials} */}
                    Date{" "}
...
export default ViewResidentIntakesContentPart1;
