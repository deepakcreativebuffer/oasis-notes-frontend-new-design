...
export default function MedicalHistorySection() {
  ...
  return (
    <>
          ...
          >
            ...
            <tbody>
              ...
              >
                ...
                <td className="text-justify">{f.commentDiabety}</td>
              </tr>
              <tr
              ...
              >
                ...
                <td className="text-justify">{f.commentHeart}</td>
              </tr>
              <tr
              ...
              >
                ...
                <td className="text-justify">{f.commentHistory}</td>
              </tr>
              <tr
              ...
              >
                ...
                <td className="text-justify">{f.commentHigh}</td>
              </tr>
              <tr
              ...
              >
                ...
                <td className="text-justify">{f.commentLung}</td>
              </tr>
              <tr
              ...
              >
                ...
                <td className="text-justify">{f.commentSeizures}</td>
              </tr>
              <tr
              ...
              >
                ...
                <td className="text-justify">{f.commentCancer}</td>
              </tr>
              <tr
              ...
              >
                ...
                <td className="text-justify">{f.commentLiver}</td>
              </tr>
              <tr
              ...
              >
                ...
                <td className="text-justify">{f.commentInjury}</td>
              </tr>
              <tr
              ...
              >
                ...
                <td className="text-justify">{f.chronicCommit}</td>
              </tr>
              <tr
              ...
              >
                ...
                <td className="text-justify">{f.AllergiesComment}</td>
              </tr>
              <tr
              ...
              >
                ...
                <td className="text-justify">{f.SurgeriesComment}</td>
              </tr>
              <tr
              ...
              >
                ...
                <td className="text-justify">{f.pregnanciesComment}</td>
              </tr>
              <tr
              ...
              >
                ...
                <td>
                  <ul className="ps-3 mb-0">
                    {f.infectionDiseases?.map((i, index) => (
                      <li className="mb-2 list-disc" key={index}>
                        {i.label}
                      </li>
                    ))}
      ...
      <Row className="mb-3">
        <Col xs={12} className="text-center hidden">
          <Button
            disabled
            type="button"
            className="theme-button hidePrint"
            onClick={f.handleAddCondition}
          >
            Add
          </Button>
        </Col>
      ...
      <Row className="mb-2">
        <Col
          xs={12}
          className={`${f.SignificantFamilyMedicalPsychiatricHistory?.length < 1 && "hidePrint"}`}
        >
