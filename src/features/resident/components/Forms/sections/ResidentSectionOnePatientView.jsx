...
import { useResidentInitialAssessmentFormContext } from "../../../pages/Intake/InitialAssessment/context/ResidentInitialAssessmentFormContext";
import { formatDateToMMDDYYYY } from "@/utils/utils";
import { ROLES } from "@/features/shared/constants";

export default function ResidentSectionOnePatientView() {
    ...
    <>
      ...
      <Row>
        ...
        <Col xs={12} sm={6} md={6} lg={4}>
          {f.userType !== ROLES.PATIENT ? (
            <div className="view-details-grid view-details-grid-inline my-1 my-md-2 p-3">
              <p className="view-label mb-1 mb-md-2">Gender : </p>
      ...
      <Row>
        ...
        >
          <div className="view-details-grid view-details-grid-inline my-1 my-md-2 p-3">
            ...
            {/* <h5 className="view-value mb-0">
                      {f.admissionStatus?.map((i) => i.label)?.join(", ")}
                     </h5> */}
            <div className="radio-inline">
              <Form.Check
                inline
      ...
      <Row>
        ...
        <Col
          ...
          md={12}
          lg={12}
          className={`${f.reasonForAdmission.length < 1 && "table-row-hide-print"}`}
        >
          <div className="view-details-grid view-details-grid-inline my-1 my-md-2 p-3">
            <p className="view-label mb-1">Presenting Problems : </p>
            <h5 className="view-value mb-0">
              {f.reasonForAdmission?.map((status) => status?.label).join(", ")}
            </h5>
          </div>
        </Col>
        ...
        <Col
          ...
          md={12}
          lg={12}
          className={`${f.residentStrengths.length < 1 && "table-row-hide-print"}`}
        >
          <div className="view-details-grid view-details-grid-inline my-1 my-md-2 p-3">
            <p className="view-label mb-1">Resident’s Strength : </p>
            <h5 className="view-value mb-0">
              {f.residentStrengths?.map((status) => status?.label).join(", ")}
            </h5>
          </div>
        </Col>
        <Col
          ...
          md={12}
          lg={12}
          className={`${!f.residentLimitations?.length && "table-row-hide-print"}`}
        >
          <Card body className="mb-3">
            <Form.Group>
              ...
              <div className="radio-inline">
                {[
                  ...
                  <Form.Check
                    ...
                    id={`barrier-${idx}`}
                    className="pointer-events-f.none"
                    checked={f.residentLimitations?.includes(opt.value)}
                  />
                ))}
