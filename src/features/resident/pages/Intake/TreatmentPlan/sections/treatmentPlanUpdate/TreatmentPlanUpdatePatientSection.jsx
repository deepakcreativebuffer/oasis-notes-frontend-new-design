...
export default function TreatmentPlanUpdatePatientSection() {
  ...
  return (
    <>
      ...
      <div className={`mb-2 ${!f.mind && "hide-data-on-view-print"}`}>
        <Row>
      ...
      <div
        className={`mb-3 ${!f.adls && !f.adlsText && "hide-data-on-view-print"}`}
      >
        <Row>
          <Col xs={12} md={12} lg={12}>
