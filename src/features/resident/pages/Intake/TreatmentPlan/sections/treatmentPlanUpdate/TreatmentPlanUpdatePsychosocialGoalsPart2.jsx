...
export default function TreatmentPlanUpdatePsychosocialGoalsPart2() {
    ...
    <>
      <Row>
        <Col>
                ...
                <Row>
                  <Col xs={12} sm={12} md={6} lg={4} xxl={4}>
                    <div className="view-details-grid-inline md-2 reactquillprint">
                      ...
                      <p>{extractParagraphText(data?.admissionMeasure)}</p>
                    </div>
                  </Col>
                  <Col xs={12} sm={12} md={6} lg={4} xxl={4}>
                    <div className="view-details-grid-inline md-2 reactquillprint">
                      ...
                      <p>{extractParagraphText(data?.currentMeasure)}</p>
                    </div>
                  </Col>
                  <Col xs={12} sm={12} md={6} lg={4} xxl={4}>
                    <div className="view-details-grid-inline md-2 reactquillprint">
                  ...
                  <tbody>
                    {f.tableshow1 && (
                      ...
                      >
                        <td>
                          {" "}
                          <p className="fw-bold"> Maintain sobriety:</p>
                        ...
                        <td className="text-justify"> <ul className="ps-3 mt-2">
                      ...
                      >
                        <td>
                          {" "}
                          <p className="fw-bold">Independent Living Skills:</p>
                          <ul className="ps-3 mt-2 mb-0">
                      ...
                      >
                        <td>
                          <p className="fw-bold"> Medication Education:</p>
                          <ul className="ps-3 mt-2 mb-0">
                      ...
                      >
                        <td>
                          <p className="fw-bold"> Managing Mental Health:</p>
                          <ul className="ps-3 mt-2 mb-0">
                      ...
                      f.otherArray.map((data, index) => (
                        ...
                        >                           <td>
                            ...
                            <SafeHtml
                              html={`${data?.otherType?.replaceAll(
                                "\n",
                                "<br/>"
                              )}`}
                            />
                          ...
                          <td className={`text-justify`}>{data?.comments}</td>
                        </tr>
                      ))}
                  </tbody>
                </Table>
          ...
          <div
            className={`${!f.residentParticipation && "hide-data-on-view-print"}`}
          >
            <Row>
              <Col xs={12} sm={12} md={12} lg={12}>
