...
export default function TreatmentPlanUpdateRiskSection() {
        ...
        <Row>
          <Col xs={12} sm={12} md={12} lg={12}>
            <div className="view-details-grid view-details-grid-inline my-1 my-md-2 p-3">
              <p className="view-label fw-bold mb-1">Behavioral Symptoms : </p>
            ...
            <div className="view-details-grid view-details-grid-inline my-1 my-md-2 p-3">
              ...
              <div className="radio-inline">
                ...
                {f.physicalSymptomsBoolean && (
                  <span className="view-value">{f.physicalSymptomsOther}</span>
                )}
              </div>
            </div>
          </Col>
