...
import { useFw4List } from "@/features/shared/services/queries";
...
const ALLFW4 = () => {
  ...
  const { data: response, isLoading: loading } = useFw4List(
    { page, limit },
  ...
  const invalidateList = useCallback(() => {
    queryClient.invalidateQueries({ queryKey: queryKeys.fw4.all() });
  }, [queryClient]);
