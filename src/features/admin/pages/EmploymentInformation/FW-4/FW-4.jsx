...
const FW4Form = () => {
  ...
  const fetchHandler = () => {
    getData(
      setData,
      employeeId ? `admin/getFW4/${employeeId}` : "employee/getFW4",
    );
  };
  ...
  const submitHandler = (e) => {
    e.preventDefault();
    employmentService.createFw4(fd, { employeeId, setLoading, navigate });
  };
  ...
  return (
    <>
      <NavWrapper title={"Fw4"} isArrow={true} />
      <Container>
