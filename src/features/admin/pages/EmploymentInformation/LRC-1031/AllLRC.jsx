...
import { useLrc1031List } from "@/features/shared/services/queries";
...
const AllLRC = () => {
  ...
  const { data: response, isLoading: loading } = useLrc1031List(
    { page, limit },
  ...
  const invalidateList = useCallback(() => {
    queryClient.invalidateQueries({ queryKey: queryKeys.lrc1031.all() });
  }, [queryClient]);
    ...
    <>
      ...
      <DeleteDocModal
        ...
        onDelete={({ additionalFunctions }) =>
          employmentService.lrc1031.remove({
            id: deleteId,
            additionalFunctions,
          })
        }
