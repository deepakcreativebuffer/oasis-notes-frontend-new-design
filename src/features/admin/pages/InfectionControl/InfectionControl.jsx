...
const InfectionControl = () => {
  ...
  const payload = {
    employeeName,
    position,
    topicsCovered: topicsCovered.map((item) => ({
      createdAt: item?.createdAt,
      topic: item?.topic || topic || "",
      teachingMethod: item?.teachingMethod || teachingMethod || "",
    })),
    employeeData,
    employeeId,
    hoursCompleted,
  ...
  const submitHandler = (e) => {
    e.preventDefault();
    trainingService.createInfectionControl(payload, {
      successMsg: "Created !",
      setLoading,
      navigate,
      additionalFunctions: [
  ...
  const canDelete = deletePermission(currentUser, "ic");
  return (
    <>
      <AddSignature
        show={open}
      ...
      <AddSignature
        ...
        setDate={setAdminSignatureDate}
        setTime={setAdminSignatureTime}
      />
              ...
              <Form.Label>
                ...
                <span className="d-inline-block mx-1">
                  <input
                    ...
                    className="min-w-auto max-w-auto w-10"
            ...
            <Col xs={12} lg={12}>
              <div className="employee-btn-joiner">
                <button
                  ...
                  type="submit"
                  disabled={
                    loading || currentUser?.userType === ROLES.ADMIN
                      ? adminSignature?.length === 0
